...
├── style.css           — Stylesheet (iOS-inspired, indigo/white)
├── app.js              — App logic + auth + storage
...
- ✅ Log DTR entries with day number, date, hours, and work details
- ✅ Auto day numbering
- ✅ Progress bar with dropdown (hours / days / percent view)
- ✅ Search entries by date, day number, or details
- ✅ Edit and delete entries
- ✅ Profile editing anytime
- ✅ Works fully offline (localStorage)
- ✅ Optional Supabase cloud sync
- ✅ Installable as PWA on iOS, Android, and desktop
- ✅ iOS-inspired UI, indigo/dark purple color scheme
